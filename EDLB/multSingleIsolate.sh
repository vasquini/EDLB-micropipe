...
nextflow main.nf --basecalling --skip_illumina --samplesheet ~/multsingle_samplesheet.csv --fast5 ~/EDLB/test_data/demultiplexed_fast5/ --outdir BDX_40X --flye_args "--asm-coverage 40"
